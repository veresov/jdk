...
class with 3000 methods and 3000 fields.

- See [PrelinkedStringConcat.java](../runtime/cds/appcds/cacheObject/PrelinkedStringConcat.java). Look for `testJavaC()`
- Run this test case in jtreg
- When completed, go to the scratch directory and do this:

```
$ grep cds,resolve *0027-dump.stdout | grep indy | wc
    177    2188   64186
```
